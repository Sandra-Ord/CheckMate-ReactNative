                    ...
                    <View className="flex-row justify-between">
                        ...
                        <View className="flex-row items-center flex-1">
                            ...
                            <View className="pl-1 flex-shrink flex-1 ">
                                ...
                                <Text className="text-xl font-bold px-1 flex-wrap" style={{color: Colors.Primary["800"]}}>
                                    {task.name}
                                </Text>
                        ...
                        <View className="flex-row items-center">
                            ...
                            <Link
                                ...
                                asChild
                            >
                                <TouchableOpacity className="px-1" onPress={() => console.log("logs")}>
                        ...
                        <View className="flex-col w-1/2 gap-y-1">
                            <View className="flex-row items-center gap-x-2 ">
                                <Ionicons className="" name="calendar-outline" size={16}
                                          style={{color: Colors.Primary["800"]}}/>
                                <Text className="flex-1">{task.next_due_at ? `Due ${formatShortDate(task.next_due_at)}` : "No due date"}</Text>
                            </View>
                            <View className="flex-row items-center gap-x-2">
